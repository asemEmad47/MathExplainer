...
public class FinalAnswerScript : MonoBehaviour
{
    ...
    public IEnumerator WriteFinalAnswer()
    {
        ...
        if (FinalAnswer.Count > 1)
        {
            ...
            TextInstantiator.InstantiateText(FirstNumPlace, "= " + finalAnswer.ToString(), PrimeFactors.XOffset - 416, GCfPlace.GetComponent<RectTransform>().anchoredPosition.y - 75, 0, true, -123);
